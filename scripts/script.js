...
if (challenges == 0) {
    ...
    for (let i = 0; i < challenges; i++) {
        ...
        if (rand == 1) {
            //append do badge
            $("#bdg").append('<div id= "bg"><img  src="images/badge2.PNG" width="50" height="50" class="ball" alt="award"></div>');
        } else {
            //append do badge
            $("#bdg").append('<div id= "bg"><img  src="images/badge.PNG" width="50" height="50" class="ball" alt="award"></div>');
        }
    }
}
